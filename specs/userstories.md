...
- AC-1: When retrieval returns insufficient context, the answer is a short refusal that explicitly says the workspace does not contain enough information to answer.
