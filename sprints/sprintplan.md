...
| B | [archive/sprint-b/](archive/sprint-b/sprint_b_tasks.md) | A-MEM-style note enrichment, agent-scoped note embeddings, mixed PDF/North workspace views, and agent UI (**closed — tag `sprint-b`**, [report](archive/sprint-b/sprint_b_report.md)) | [north-agents-amem.md](../specs/openspecs/north-agents-amem.md) FR-5, FR-7, FR-9 |
